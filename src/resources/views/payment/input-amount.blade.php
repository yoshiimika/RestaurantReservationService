...
<div class="input-amount-form__content">
    <div class="input-amount-form__heading">
        <h2 class="input-amount-form__heading-title">
            支払い金額を入力してください
        </h2>
    </div>
    <form action="{{ route('payment.checkout') }}" class="form" method="GET">
    @csrf
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--amount">
                    <input id="amount" name="amount" type="number" placeholder="例: 5000">
                </div>
