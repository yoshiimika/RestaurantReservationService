...
<div class="confirm-container">
    <div class="confirm-card">
        <h2 class="confirm-title">{{ $reservation->shop->name }}の予約変更内容を確認</h2>
        ...
        <div class="button__group">
            <form action="{{ route('reservations.edit.update', $reservation->id) }}" method="POST" class="reservation-form">
                @method('PATCH')
                @csrf
